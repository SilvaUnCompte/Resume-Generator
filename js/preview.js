...
function buildHeader() {
  ...
  let linkedInDisplay = state.linkedin ? state.linkedin.replace(/^https?:\/\//, "") : ""
      ...
      return `
            <div class="timeline-item" data-id="edu-${edu.id}">
              <div class="timeline-icon">
                <img src="${TIMELINE_IMAGES.bullet}" class="timeline-bullet" alt="">
                ${!isLast ? `<img src="${TIMELINE_IMAGES.dash}" class="timeline-dash" alt="">` : ""}
              </div>
